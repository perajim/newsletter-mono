...
export default function ModalAddEmails(props) {
    ...
    const createNewsletter = (e) => {
        e.preventDefault(); 
        let { number } = document.forms[1];
        console.log("VALOR: "+number.value)
    } 
  return (
          ...
          >
            ...
            <form onSubmit={createNewsletter}>
                ...
                <div class="flex justify-center">
                    ...
                    <input name="number" type="name" id="number" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Ingrese el nombre del newsletter" required/>
                </div>
                <div class="flex justify-center">
                    <div class="mb-1 ">
